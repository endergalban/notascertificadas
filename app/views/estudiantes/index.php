                  ...
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
						...
						<ul class="dropdown-menu" role="menu">
							<li><a href="<?php echo site_url(array('user','estudiantes'));?>">Registros</a>
							</li>
							<li><a href="<?php echo site_url(array('user','estudiantes', 'nuevoestudiante'));?>">Nuevo Registro</a>
							</li>
							<li><a target="_BLANK" href="<?php echo site_url(array('reportes', 'rep_estudiantes'));?>">Descargar</a>
							</li>
						</ul>
						</li>
